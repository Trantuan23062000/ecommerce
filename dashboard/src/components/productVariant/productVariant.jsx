    ...
    <div className="container mx-auto">
      ...
      {showDelete ? (
       ...
       <div className="py-4 ml-4 flex items-center gap-3">
        ...
        <p className="text-gray-600 font-medium">ProductVariant</p>
      </div>
                    ...
                    data && data.length > 0 ? (
                      data.map((item, index) => (
                        <tr className="border-b dark:border-gray-700">
                          ...
                          <td className="px-4 py-3"> {item.Product ? item.Product.name : ""}</td>
                          <td className="px-4 py-3"> {item.productVariant ? item.productVariant.quantity : ""}</td>
                          <td className="px-4 py-3">{item.productVariant ? item.productVariant.Color.color : ""}</td>
              ...
              <ul className="inline-flex items-stretch -space-x-px">
                ...
                <li>
                  <div key={i}
                    ...
                    disabled={currentPage === i + 1} className="flex items-center justify-center text-sm py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                    {i+1}
                  </div>
                </li>
                 ))}
